describe("createClassInstance", function() {
	...
	describe('Constructor is not returning anything', function () {
		...
		it('Should return an object and not a null', function () {
			var res = rule.createClassInstance(Example);
		...
		it('Should pass proper arguments to the constructor function', function () {
			var res = rule.createClassInstance(Example, 'uno', 'duo');
		...
		it('Instance attributes should be unique for every instance', function () {
			var res1 = rule.createClassInstance(Example), res2 = rule.createClassInstance(Example);
		...
		describe('Prototype', function () {
			var res1, res2;
			beforeEach(function () {
				res1 = rule.createClassInstance(Example);
				res2 = rule.createClassInstance(Example);
			});
	...
	describe('Contructor returns a value', function () {
		...
		beforeEach(function () {
			...
			res = rule.createClassInstance(Example);
		});
